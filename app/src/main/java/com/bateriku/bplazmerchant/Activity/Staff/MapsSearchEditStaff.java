...
public class MapsSearchEditStaff extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                EditStaff.latitude = String.valueOf(Double.parseDouble(latlong[0]));
                EditStaff.longitude = String.valueOf(Double.parseDouble(latlong[1]));
...
//        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        MapsSearchEditStaff.this.overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }

    public void getLocation() {
        gpsTracker = new GpsTracker(MapsSearchEditStaff.this);
    ...
    private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
        ...
        try {
            ...
            if (addresses != null) {
                ...
                EditStaff.latitude = String.valueOf(LATITUDE);
                EditStaff.longitude = String.valueOf(LONGITUDE);
                EditStaff.et_address.setText(strReturnedAddress.toString());
            } else {
            }
        } catch (Exception e) {
            e.printStackTrace();
