...
public class ToAcceptsAdapter extends RecyclerView.Adapter<ToAcceptsAdapter.ProductViewHolder> implements Filterable {
    ...
    public ToAcceptsAdapter(Context mCtx, List<ToAcceptClass> jobByMonthList, onClickJobByMonth mListener, Activity activity) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.adapter_to_accepts, null,false);
    ...
    public void onBindViewHolder(final ProductViewHolder holder, final int position) {
        ...
        holder.textView_cust_nams2.setText(jobByMonthClass.getCustomer_name());
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView textView_date,textView_job_id,textView_address,textView_product,textView_price,textView_status,textView_cust_nams2;
        ...
        public ProductViewHolder(View itemView) {
            ...
            textView_cust_nams2 = itemView.findViewById(R.id.textView_cust_nams2);
