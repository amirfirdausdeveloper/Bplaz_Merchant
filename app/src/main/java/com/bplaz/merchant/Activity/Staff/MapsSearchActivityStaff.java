...
public class MapsSearchActivityStaff extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                AddStaff.latitude = String.valueOf(Double.parseDouble(latlong[0]));
                AddStaff.longitude = String.valueOf(Double.parseDouble(latlong[1]));
...
//        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        MapsSearchActivityStaff.this.overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }

    public void getLocation() {
        gpsTracker = new GpsTracker(MapsSearchActivityStaff.this);
    ...
    private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
        ...
        try {
            ...
            if (addresses != null) {
                ...
                AddStaff.latitude = String.valueOf(LATITUDE);
                AddStaff.longitude = String.valueOf(LONGITUDE);
                AddStaff.et_address.setText(strReturnedAddress.toString());
            } else {
            }
        } catch (Exception e) {
            e.printStackTrace();
