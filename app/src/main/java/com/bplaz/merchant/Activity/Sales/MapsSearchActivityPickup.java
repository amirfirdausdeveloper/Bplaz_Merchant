...
import com.bplaz.merchant.Activity.Staff.AddStaff;
...
public class MapsSearchActivityPickup extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                CreateSales.latitude = String.valueOf(Double.parseDouble(latlong[0]));
                CreateSales.longitude = String.valueOf(Double.parseDouble(latlong[1]));
...
//        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        MapsSearchActivityPickup.this.overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }

    public void getLocation() {
        gpsTracker = new GpsTracker(MapsSearchActivityPickup.this);
    ...
    private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
        ...
        try {
            ...
            if (addresses != null) {
                ...
                CreateSales.latitude = String.valueOf(LATITUDE);
                CreateSales.longitude = String.valueOf(LONGITUDE);
                CreateSales.et_address.setText(strReturnedAddress.toString());
            } else {
            }
        } catch (Exception e) {
            e.printStackTrace();
